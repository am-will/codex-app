...
const rendererLinuxWindowControlsSafeAreaPatchReplacement =
  'linux:Object.freeze({left:0,right:0})';
...
const appShellLinuxWindowControlsPatchMarker = 'onFocus:()=>u(!0),onBlur:()=>u(!1),onClick:n(`close`)';
const appShellLinuxWindowControlsTopBarPatchTarget =
  'group/windows-top-bar z-40 flex h-toolbar-sm items-center ps-(--spacing-token-safe-header-left) pe-(--spacing-token-safe-header-right)';
...
const appShellLinuxFloatingSidebarHideNavHeaderPatchTarget =
  'children:[(0,Q.jsx)(U.div,{initial:s?!1:{x:8},animate:{x:0},exit:{x:s?0:8},transition:h,className:`app-header-tint flex h-toolbar shrink-0 items-center ps-(--spacing-token-safe-header-left) pe-2`,children:(0,Q.jsx)(qn,{hideUnreadBadge:!0,onToggleSidebar:l})}),(0,Q.jsx)(`div`,{className:`min-h-0 flex-1 overflow-hidden`,children:a})]';
const appShellLinuxFloatingSidebarHideNavHeaderPatchReplacement =
  'children:[r?null:(0,Q.jsx)(U.div,{initial:s?!1:{x:8},animate:{x:0},exit:{x:s?0:8},transition:h,className:`app-header-tint flex h-toolbar shrink-0 items-center ps-(--spacing-token-safe-header-left) pe-2`,children:(0,Q.jsx)(qn,{hideUnreadBadge:!0,onToggleSidebar:l})}),(0,Q.jsx)(`div`,{className:`min-h-0 flex-1 overflow-hidden`,children:a})]';
const appShellLinuxFloatingSidebarHideNavHeaderPatchMarker =
  'children:[r?null:(0,Q.jsx)(U.div,{initial:s?!1:{x:8}';
const appShellLinuxFloatingSidebarZIndexPatchTarget =
...
const appShellLinuxFloatingSidebarInlineZIndexPatchTarget =
  'exit:{opacity:0,x:s?0:-8},style:{width:n},transition:h,children:[(0,Q.jsxs)(`aside`';
const appShellLinuxFloatingSidebarInlineZIndexPatchReplacement =
  'exit:{opacity:0,x:s?0:-8},style:{width:n,zIndex:40},transition:h,children:[(0,Q.jsxs)(`aside`';
...
const appShellLinuxFloatingSidebarMainHeaderLeftPatchTarget =
  'function vr({isHeaderEdgeScroll:e,isWindowsMenuBarEnabled:t}){let{headerLeftWidth:n,headerRightWidth:r,leftPanelAnimatedWidth:i,rightPanelAnimatedWidth:a}=Je(),o=Kt(0),s=Jt`${i}px`,l=Jt`${a}px`,u=y(fe)';
const appShellLinuxFloatingSidebarMainHeaderLeftPatchReplacement =
  'function vr({isHeaderEdgeScroll:e,isWindowsMenuBarEnabled:t}){let{headerLeftWidth:n,headerRightWidth:r,leftPanelAnimatedWidth:i,rightPanelAnimatedWidth:a,leftPanelWidth:lp}=Je(),flw=y(Wr),fls=y(Ze),o=Kt(0),s=Jt`${i}px`,l=Jt`${a}px`,u=y(fe)';
const appShellLinuxFloatingSidebarMainHeaderLeftStylePatchTarget =
  'style:t?{left:s}:{},children:[(0,Q.jsx)(yr,{entries:p,fitWidth:n,slotWidth:t?o:i,side:`start`})';
const appShellLinuxFloatingSidebarMainHeaderLeftStylePatchReplacement =
  'style:t?{left:flw&&!fls?`${Math.max(lp.get(),i.get())}px`:s}:{},children:[(0,Q.jsx)(yr,{entries:p,fitWidth:n,slotWidth:t?o:i,side:`start`})';
  ...
  return summarizePatchResults(
    applyPatchesToFile(appShellPath, [
      ...
      },
      {
        ...
        target: appShellLinuxFloatingSidebarZIndexPatchTarget,
