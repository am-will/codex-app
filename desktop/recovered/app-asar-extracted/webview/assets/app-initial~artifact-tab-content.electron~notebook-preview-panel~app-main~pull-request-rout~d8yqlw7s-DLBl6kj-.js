import{n as e,s as t}from"./rolldown-runtime-BG2f4sTM.js";import{E as n,O as r,b as i,un as a,vt as o,x as s,y as c}from"./app-initial~avatarOverlayCompositionSurface~index-9fQ9wihu~index-BFCcxPM5~mapbox-gl-DVWlwqb~kppdhley-cTPFNKbJ.js";import{C as l,Cn as u,Ga as d,In as f,S as p,Ua as m,b as ee,do as h,ho as te,lo as g,n as ne,o as _,po as v,qa as y,r as b,uo as x,w as S,wn as C,x as w}from"./app-initial~avatarOverlayCompositionSurface~artifact-tab-content.electron~notebook-preview-~ngwudnyz-CMdnikYo.js";import{D as re,O as T,ft as E,lt as D}from"./app-initial~avatarOverlayCompositionSurface~artifact-tab-content.electron~notebook-preview-~l16cgjx9-CcowRPQw.js";import{n as O}from"./app-initial~avatarOverlayCompositionSurface~artifact-tab-content.electron~notebook-preview-~g8980z4e-DMwNkiuM.js";import{a as k,s as ie}from"./app-initial~avatarOverlayCompositionSurface~artifact-tab-content.electron~notebook-preview-~nssizff1-CAZN1XRY.js";import{I as A,bt as ae}from"./app-initial~artifact-tab-content.electron~notebook-preview-panel~app-main~business-checkout~oxnpxkxc-BfxY_MI9.js";import{H as oe,K as se,N as j,W as M,k as N}from"./app-initial~artifact-tab-content.electron~notebook-preview-panel~app-main~business-checkout~mgfw3nls-CFWqUJ7v.js";import{i as ce,t as P}from"./app-initial~artifact-tab-content.electron~notebook-preview-panel~app-main~business-checkout~hm0a50up-DCei3hLk.js";import{a as F,c as le,i as ue,l as de,n as I,o as fe,r as L,s as R,t as pe,u as me}from"./app-initial~artifact-tab-content.electron~notebook-preview-panel~app-main~settings-command-~kt7wj8fo-DSqSkB5H.js";function z(e){let t=(0,B.c)(2),r;return t[0]===e?r=t[1]:(r=e==null?void 0:{hostId:e},t[0]=e,t[1]=r),n(N,r)}function he(e){return z(e).data?.codexHome}var B,V=e((()=>{B=a(),s(),j()})),H,U=e((()=>{H=`<svg width="192" height="192" viewBox="0 0 192 192" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`}));function St(e){let t=0;for(let n=0;n<e.length;n+=1)t=(t*31+e.charCodeAt(n))%Ct.length;return Ct[t]??``}var Ct,wt=e((()=>{De(),ke(),je(),Ne(),Fe(),Le(),ze(),Ve(),Ue(),Ge(),qe(),Ye(),Ze(),$e(),tt(),rt(),at(),st(),lt(),dt(),pt(),ht(),_t(),yt(),xt(),Ct=[Ee,Oe,Ae,Me,Pe,Ie,Re,Be,He,We,Ke,Je,Qe,Xe,et,nt,it,ot,ct,ut,ft,mt,gt,vt,bt].map(e=>`data:image/svg+xml,${encodeURIComponent(e)}`)}));async function Tt(e,t,n){let r=Et(e);if(r==null)return null;try{let e={path:r,hostId:t},i=await n.fetchQuery({queryFn:({signal:t})=>ne(`read-file-binary`,{params:e,signal:t}),queryKey:b(`read-file-binary`,e),retry:!1,gcTime:1/0,staleTime:p.INFINITE});return i.contentsBase64?`data:${Dt(r)};base64,${i.contentsBase64}`:null}catch(e){return w.warning(`Failed to inline local image`,{safe:{},sensitive:{error:e,resolvedImagePath:r}}),null}}function Et(e){if(e==null)return null;let t=e.trim();if(t.length===0)return null;let n=t.toLowerCase();if(n.startsWith(`data:`)||n.startsWith(`http:`)||n.startsWith(`https:`)||n.startsWith(`file:`)||n.startsWith(`vscode-resource:`)||n.startsWith(`vscode-webview:`)||n.startsWith(`vscode-file:`))return null;let r=v(t);return g(r)?r:null}function Dt(e){return kt[Ot.default.extname(e).toLowerCase()]??`application/octet-stream`}var Ot,kt,At=e((()=>{Ot=t(te(),1),S(),ee(),l(),_(),kt={".svg":`image/svg+xml`,".png":`image/png`,".jpg":`image/jpeg`,".jpeg":`image/jpeg`,".webp":`image/webp`,".gif":`image/gif`,".avif":`image/avif`}}));function jt(e){return{...yn(e.summary),description:e.summary.interface?.shortDescription??e.description??null,displayName:e.summary.interface?.displayName??null,marketplaceDisplayName:null,marketplaceName:e.marketplaceName,plugin:e.summary,keywords:e.summary.keywords,...Bt({marketplaceName:e.marketplaceName,marketplacePath:e.marketplacePath})}}function Mt({marketplacePath:e,remoteMarketplaceName:t}){if(e!=null&&t!=null)throw Error(`plugin marketplace request requires one marketplace source`);if(e!=null)return{marketplacePath:e};if(t!=null)return{remoteMarketplaceName:t};throw Error(`plugin marketplace request requires a marketplace source`)}function Nt(e){return e.marketplacePath??`remote:${e.remoteMarketplaceName}`}function Pt(e){let t=e.plugin.remotePluginId??e.plugin.shareContext?.remotePluginId;return`${Nt(e)}:${e.plugin.id}:${t??``}`}function Ft(e){return e.filter(e=>{let t=cn(e).toLowerCase();return!Mn.some(e=>t===e||t.startsWith(`${e}-`))})}function It(e){return e.marketplacePath==null?Rt(e.plugin):e.plugin.name}function Lt(e){return e.marketplacePath==null?Rt(e.plugin):e.plugin.id}function Rt(e){if(e.remotePluginId==null)throw Error(`remote plugin ${e.id} is missing remotePluginId`);return e.remotePluginId}function zt(e){return{...Mt(e),pluginName:It(e)}}function Bt({marketplaceName:e,marketplacePath:t}){return t==null?{marketplacePath:null,remoteMarketplaceName:e}:{marketplacePath:t,remoteMarketplaceName:null}}function Vt(e,t,i){let a=(0,bn.c)(65),o;a[0]===e?o=a[1]:(o={hostId:e},a[0]=e,a[1]=o);let s=ue(o)&&(i?.enabled??!0),c=i?.additionalMarketplaceKinds??Tn,l=i?.installSuggestionPluginNames??null,u=ie(`4218407052`),d=ce(e)?.authMethod??null,f;a[2]===d?f=a[3]:(f=we(d),a[2]=d,a[3]=f);let p=f,m=i?.includeRemoteCatalog??!0,ee=!u,h;a[4]!==c||a[5]!==m||a[6]!==ee?(h=qt({additionalMarketplaceKinds:c,includeRemoteCatalog:m,includeVerticalCatalog:ee}),a[4]=c,a[5]=m,a[6]=ee,a[7]=h):h=a[7];let te=h,g=se(),ne=r(ae),_;a[8]!==e||a[9]!==ne?(_=ne.includes(e),a[8]=e,a[9]=ne,a[10]=_):_=a[10];let v=_,y=t===void 0,b;a[11]===e?b=a[12]:(b={hostId:e},a[11]=e,a[12]=b);let x=s&&v&&y,S;a[13]===x?S=a[14]:(S={enabled:x},a[13]=x,a[14]=S);let C=n(oe,b,S),w=he(e),re=s&&v,T;a[15]!==e||a[16]!==re?(T={enabled:re,hostId:e},a[15]=e,a[16]=re,a[17]=T):T=a[17];let E=me(T),D;a[18]===e?D=a[19]:(D={hostId:e},a[18]=e,a[19]=D);let O=fe(D),k;a[20]===e?k=a[21]:(k={hostId:e},a[20]=e,a[21]=k);let A=le(k),j=C.data?.roots,M;a[22]!==w||a[23]!==e||a[24]!==t||a[25]!==j?(M=hn({codexHome:w,hostId:e,rootsOverrideCwd:t,workspaceRoots:j}),a[22]=w,a[23]=e,a[24]=t,a[25]=j,a[26]=M):M=a[26];let N=M,P=s&&v&&(t!==void 0||C.isFetched),F;a[27]===Symbol.for(`react.memo_cache_sentinel`)?(F=pe(),a[27]=F):F=a[27];let de=F,I;a[28]!==e||a[29]!==l||a[30]!==u||a[31]!==te||a[32]!==N||a[33]!==p?(I={buildFlavor:de,hostId:e,installSuggestionPluginNames:l,isOpenAICuratedRemoteMarketplaceEnabled:u,marketplaceKinds:te,roots:N,shouldHideOpenAICuratedMarketplaces:p},a[28]=e,a[29]=l,a[30]=u,a[31]=te,a[32]=N,a[33]=p,a[34]=I):I=a[34];let L;a[35]===P?L=a[36]:(L={enabled:P},a[35]=P,a[36]=L);let R=n(Pn,I,L);if(!s||!v){let e;return a[37]===Symbol.for(`react.memo_cache_sentinel`)?(e={availablePlugins:$,featuredPluginIds:Cn,installedPlugins:$,marketplaceLoadErrors:wn,marketplaces:Dn,errorMessage:null,isLoading:!1,isFetching:!1,refetch:Ut,forceReload:Ht},a[37]=e):e=a[37],e}let z,B,V,H;a[38]!==E.available||a[39]!==A.available||a[40]!==O.available||a[41]!==R.data?.featuredPluginIds||a[42]!==R.data?.plugins?(z={isComputerUseAvailable:E.available,isExternalBrowserUseAvailable:A.available,isInAppBrowserUseAvailable:O.available},B=R.data?.plugins??$,V=$t({plugins:B,...z}),H=Qt({featuredPluginIds:R.data?.featuredPluginIds??Cn,...z}),a[38]=E.available,a[39]=A.available,a[40]=O.available,a[41]=R.data?.featuredPluginIds,a[42]=R.data?.plugins,a[43]=z,a[44]=B,a[45]=V,a[46]=H):(z=a[43],B=a[44],V=a[45],H=a[46]);let U;a[47]===B?U=a[48]:(U=en(B),a[47]=B,a[48]=U);let W=R.data?.marketplaceLoadErrors??wn,ge=R.data?.marketplaces??Dn,G=R.error?String(R.error.message):null,K=y&&C.isLoading||R.isLoading||O.isLoading||A.isLoading||E.isLoading,q=y&&C.isFetching||R.isFetching||E.isFetching,J;a[49]!==z||a[50]!==R?(J=async()=>{let e=(await R.refetch()).data?.plugins??$;return{availablePlugins:$t({plugins:e,...z}),installedPlugins:en(e)}},a[49]=z,a[50]=R,a[51]=J):J=a[51];let Y;a[52]===g?Y=a[53]:(Y=()=>g(Q),a[52]=g,a[53]=Y);let X;return a[54]!==V||a[55]!==H||a[56]!==U||a[57]!==W||a[58]!==ge||a[59]!==G||a[60]!==K||a[61]!==q||a[62]!==J||a[63]!==Y?(X={availablePlugins:V,featuredPluginIds:H,installedPlugins:U,marketplaceLoadErrors:W,marketplaces:ge,errorMessage:G,isLoading:K,isFetching:q,refetch:J,forceReload:Y},a[54]=V,a[55]=H,a[56]=U,a[57]=W,a[58]=ge,a[59]=G,a[60]=K,a[61]=q,a[62]=J,a[63]=Y,a[64]=X):X=a[64],X}async function Ht(){}async function Ut(){return{availablePlugins:$,installedPlugins:$}}function Wt(e){let t=(0,bn.c)(7),{enabled:r,hostId:i,marketplaceKind:a}=e,o=r===void 0?!0:r,s;t[0]===i?s=t[1]:(s={hostId:i},t[0]=i,t[1]=s);let c=ue(s),l;t[2]!==i||t[3]!==a?(l={hostId:i,marketplaceKind:a},t[2]=i,t[3]=a,t[4]=l):l=t[4];let u=o&&c,d;return t[5]===u?d=t[6]:(d={enabled:u},t[5]=u,t[6]=d),n(Fn,l,d)}function Gt(e,t,n=Tn,r=null,i=!1,a=!1){return r==null?Jt(e,t,qt({additionalMarketplaceKinds:n,includeRemoteCatalog:!0,includeVerticalCatalog:!i}),i,a):Kt([...Q,e,t,`installed`,r,`curated-marketplace`,Yt(i)],a)}function Kt(e,t){return t?[...e,xn]:e}function qt({additionalMarketplaceKinds:e,includeRemoteCatalog:t,includeVerticalCatalog:n}){return t&&!n&&e.length===0?null:n?[`local`,`vertical`,...e]:[`local`,...e]}function Jt(e,t,n,r,i){let a=Yt(r);return Kt(n==null?[...Q,e,t,`curated-marketplace`,a]:[...Q,e,t,`marketplace-kinds`,n,`curated-marketplace`,a],i)}function Yt(e){return e?C:u}function Xt({isOpenAICuratedRemoteMarketplaceEnabled:e,shouldHideOpenAICuratedMarketplaces:t}){return t?kn:e?On:En}function Zt(e,t){return t.length===0?e:e.filter(e=>!t.includes(e.name))}function Qt({featuredPluginIds:e,...t}){return e.filter(e=>rn(e,t))}function $t({plugins:e,...t}){return e.filter(e=>rn(e.plugin.id,t))}function en(e){return e.filter(e=>e.plugin.installed)}function tn({enabled:e,hostId:t,installed:n,pluginId:r,queryClient:i}){i.setQueriesData({queryKey:[...Q,t]},t=>{if(t==null)return t;let i=nn({enabled:e,installed:n,pluginId:r,plugins:t.plugins});return i===t.plugins?void 0:{...t,plugins:i}}),i.setQueriesData({queryKey:[...Q,`marketplace-kind`,t]},t=>{if(t==null)return;let i=nn({enabled:e,installed:n,pluginId:r,plugins:t});return i===t?void 0:i}),i.setQueriesData({queryKey:[...Q,`detail`,t]},t=>{if(!(t==null||t.summary.id!==r||t.summary.installed===n&&t.summary.enabled===e))return{...t,summary:{...t.summary,enabled:e,installed:n}}})}function nn({enabled:e,installed:t,pluginId:n,plugins:r}){return r.some(r=>r.plugin.id===n&&(r.plugin.installed!==t||r.plugin.enabled!==e))?r.map(r=>r.plugin.id===n?{...r,plugin:{...r.plugin,enabled:e,installed:t}}:r):r}function rn(e,{isComputerUseAvailable:t,isExternalBrowserUseAvailable:n,isInAppBrowserUseAvailable:r}){return!(!r&&an(e)||!n&&on(e)||!t&&sn(e))}function an(e){let t=cn(e);return t===`browser`||t===`browser-use`}function on(e){let t=cn(e);return t===`chrome`||t===`chrome-dev`||t===`chrome-internal`}function sn(e){return cn(e)===An}function cn(e){return e.split(`@`)[0]}function ln({buildFlavor:e,featuredPluginIds:t}){let n=d(e);return t.filter(e=>{let t=f(e);return t==null?!0:!y(t)||t===n})}function un({buildFlavor:e,plugins:t}){let n=d(e);return t.filter(e=>!y(e.marketplaceName)||e.marketplaceName===n)}function dn(e){return e.trim().toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/^-+|-+$/g,``)}function fn(e){return Nn.has(dn(e))}function pn(e){let t=new Map;for(let n of e){let e=`${n.name}\u0000${n.path??``}`;if(t.has(e))continue;let r=fn(n.name);t.set(e,{displayName:n.interface?.displayName??null,isBuiltIn:r,name:n.name,path:n.path,pluginCount:n.plugins.length})}return Array.from(t.values()).sort((e,t)=>{let n=e.displayName?.trim()||e.name,r=t.displayName?.trim()||t.name;return n.localeCompare(r)})}async function mn({hostId:e,plugins:t,queryClient:n}){let r=[...t];async function i(a){let o=t[a];if(o==null)return;let[s,c,l]=await Promise.all([Tt(o.composerIconPath,e,n),Tt(o.logoPath,e,n),Tt(o.logoDarkPath,e,n)]);(s!=null||c!=null||l!=null)&&(r[a]={...o,composerIconPath:s??o.composerIconPath,logoDarkPath:l??o.logoDarkPath,logoPath:c??o.logoPath,plugin:o.plugin.interface?{...o.plugin,interface:{...o.plugin.interface,composerIcon:s??o.plugin.interface.composerIcon,logo:c??o.plugin.interface.logo,...l==null?{}:{logoDark:l}}}:o.plugin}),await i(a+Sn)}return await Promise.all(Array.from({length:Math.min(Sn,t.length)},(e,t)=>i(t))),r}function hn({codexHome:e,hostId:t,rootsOverrideCwd:n,workspaceRoots:r}){let i=t===`local`&&e!=null?E(e,jn):null;return gn([...typeof n==`string`?[n]:n??r??[],...i==null?[]:[i]],e)}function gn(e,t){return Array.from(new Set(e.map(e=>e.trim()).filter(e=>g(e)&&_n(e,t))))}function _n(e,t){return t==null?!0:x(t)||h(t)?x(e)||h(e):e.startsWith(`/`)&&!e.startsWith(`//`)}function vn(e,t=$){let n=new Map,r=new Set;for(let t of e)for(let e of t.plugins){e.installed||r.add(e.id);let i={...yn(e),description:e.interface?.shortDescription??null,displayName:e.interface?.displayName??null,marketplaceDisplayName:t.interface?.displayName??null,marketplaceName:t.name,plugin:e,keywords:e.keywords,...Bt({marketplaceName:t.name,marketplacePath:t.path})},a=n.get(e.id);if(a==null){n.set(e.id,i);continue}let o=a;(a.plugin.installed&&!e.installed||a.plugin.installed===e.installed&&a.plugin.interface==null&&e.interface!=null)&&(o=i),a.plugin.installed&&!e.installed&&n.delete(e.id);let s=null;if(a.plugin.installed?s=a.plugin:e.installed&&(s=e),s==null){n.set(e.id,o);continue}n.set(e.id,{...o,plugin:{...o.plugin,enabled:s.enabled,installed:!0,installPolicy:s.installPolicy,localVersion:s.localVersion,remotePluginId:o.plugin.remotePluginId??s.remotePluginId}})}let i=new Map(t.map(e=>[e.plugin.id,e])),a=!1,o=Array.from(n.values()).map(e=>{let t=i.get(e.plugin.id);return!e.plugin.installed||t==null||r.has(e.plugin.id)?e:(a||=e.marketplaceName!==t.marketplaceName||e.marketplacePath!==t.marketplacePath,{...t,plugin:{...e.plugin,id:t.plugin.id,interface:t.plugin.interface??e.plugin.interface,keywords:t.plugin.keywords??e.plugin.keywords,name:t.plugin.name,remotePluginId:t.plugin.remotePluginId??e.plugin.remotePluginId,shareContext:t.plugin.shareContext??e.plugin.shareContext,source:t.plugin.source}})});if(!a)return o;let s=new Map(o.map(e=>[e.plugin.id,e]));return[...t.flatMap(e=>{let t=s.get(e.plugin.id);return s.delete(e.plugin.id),t==null?[]:[t]}),...s.values()]}function yn(e,t){let n=e.interface,r=n?.composerIcon??n?.composerIconUrl,i=n?.logo??n?.logoUrl,a=n?.logoDark??n?.logoUrlDark,o=ye(e),s=i!=null||a!=null,c=r??(s?null:o),l=s?i??a??null:o??t?.logoUrl??t?.logoUrlDark??null,u=s?a??null:o??t?.logoUrlDark??t?.logoUrl??null;if(c!=null||l!=null)return{composerIconPath:c,logoDarkPath:u,logoPath:l};let d=St(e.id);return{composerIconPath:d,logoDarkPath:d,logoPath:d}}var bn,Q,xn,Sn,Cn,wn,Tn,En,Dn,$,On,kn,An,jn,Mn,Nn,Pn,Fn,In=e((()=>{bn=a(),s(),S(),A(),re(),P(),V(),de(),R(),F(),L(),M(),i(),j(),O(),k(),I(),D(),l(),Ce(),Te(),wt(),At(),Q=[`plugins`],xn=`openai-curated-marketplaces-hidden`,Sn=4,Cn=[],wn=[],Tn=[],En=[],Dn=[],$=[],On=[u],kn=[u,C],An=`computer-use`,jn=`.tmp/marketplaces/openai-internal-testing`,Mn=[`datadog`,`statsig`],Nn=new Set([`codex-official`,m,u,C,`openai-primary-runtime`].map(dn)),Pn=o(c,({buildFlavor:e,hostId:t,installSuggestionPluginNames:n,isOpenAICuratedRemoteMarketplaceEnabled:r,marketplaceKinds:i,roots:a,shouldHideOpenAICuratedMarketplaces:o},{queryClient:s})=>{let c=Xt({isOpenAICuratedRemoteMarketplaceEnabled:r,shouldHideOpenAICuratedMarketplaces:o}),l=n==null?Jt(t,a,i,r,o):Gt(t,a,Tn,n,r,o);return{queryKey:l,queryFn:async()=>{if(n!=null){let e=await T(`send-cli-request-for-host`,{hostId:t,method:`plugin/installed`,params:{...a.length>0?{cwds:a}:{},installSuggestionPluginNames:n}}),r=Zt(e.marketplaces,c),i=vn(r,s.getQueryData(l)?.plugins);return{featuredPluginIds:Cn,marketplaceLoadErrors:e.marketplaceLoadErrors,marketplaces:pn(r),plugins:await mn({hostId:t,plugins:i,queryClient:s})}}let r=await T(`list-plugins`,i==null?{hostId:t,...a.length>0?{cwds:a}:{}}:{hostId:t,...a.length>0?{cwds:a}:{},marketplaceKinds:i}),o=Zt(r.marketplaces,c),u=vn(o,s.getQueryData(l)?.plugins),d=e==null?u:un({buildFlavor:e,plugins:u}),f=Ft(r.featuredPluginIds).filter(e=>!c.some(t=>e.endsWith(`@${t}`)));return{featuredPluginIds:e==null?f:ln({buildFlavor:e,featuredPluginIds:f}),marketplaceLoadErrors:r.marketplaceLoadErrors,marketplaces:pn(o),plugins:await mn({hostId:t,plugins:d,queryClient:s})}},staleTime:p.SIX_HOURS,gcTime:1/0}}),Fn=o(c,({hostId:e,marketplaceKind:t},{queryClient:n})=>{let r=[...Q,`marketplace-kind`,e,t];return{queryKey:r,queryFn:async()=>vn((await T(`list-plugins`,{hostId:e,marketplaceKinds:[t]})).marketplaces,n.getQueryData(r)),staleTime:p.SIX_HOURS}})}));export{he as A,Wt as C,Te as D,Tt as E,we as O,Vt as S,At as T,fn as _,yn as a,an as b,Mt as c,It as d,hn as f,mn as g,In as h,Xt as i,z as j,V as k,Pt as l,Rt as m,jt as n,qt as o,Lt as p,vn as r,Nt as s,Q as t,zt as u,sn as v,Et as w,tn as x,on as y};
//# sourceMappingURL=app-initial~artifact-tab-content.electron~notebook-preview-panel~app-main~pull-request-rout~d8yqlw7s-DLBl6kj-.js.map