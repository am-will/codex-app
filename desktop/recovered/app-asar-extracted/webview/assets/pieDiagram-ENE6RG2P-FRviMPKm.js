import{n as e}from"./rolldown-runtime-DAXXjFlN.js";import{Hat as t,Lat as n,Oot as r}from"./app-initial-iBPGfcXU.js";import{n as i,r as a}from"./chunk-Y2CYZVJY-C9L_9xF4.js";import{l as o,t as s,u as c}from"./src-GELAvvgW.js";import{U as l,W as u,a as d,c as f,f as p,j as m,q as h,v as g,w as _,x as v,y}from"./chunk-WYO6CB5R-BEL2IWz7.js";import{n as b,t as x}from"./chunk-VAUOI2AC-Co5rCc0a.js";import{n as S,t as C}from"./chunk-JWPE2WC7-Blh_Vn-A.js";import{n as w,r as T}from"./mermaid-parser.core-DLNmBpaA.js";import{d as E,i as D,m as O}from"./chunk-ICXQ74PX-Dn_cmSJa.js";var k,A,j,M,N,P,F,I,L,R,z;e((()=>{C(),x(),E(),m(),o(),a(),w(),s(),k=p.pie,A={sections:new Map,showData:!1,config:k},j=A.sections,M=A.showData,N=structuredClone(k),P={getConfig:i(()=>structuredClone(N),`getConfig`),clear:i(()=>{j=new Map,M=A.showData,d()},`clear`),setDiagramTitle:h,getDiagramTitle:_,setAccTitle:u,getAccTitle:y,setAccDescription:l,getAccDescription:g,addSection:i(({label:e,value:t})=>{if(t<0)throw Error(`"${e}" has invalid value: ${t}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);j.has(e)||(j.set(e,t),c.debug(`added new section: ${e}, with value: ${t}`))},`addSection`),getSections:i(()=>j,`getSections`),setShowData:i(e=>{M=e},`setShowData`),getShowData:i(()=>M,`getShowData`)},F=i((e,t)=>{S(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},`populateDb`),I={parse:i(async e=>{let t=await T(`pie`,e);c.debug(t),F(t,P)},`parse`)},L=i(e=>`
  .pieCircle{
