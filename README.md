...
- Current Linux artifact versioning follows the embedded Electron app version `26.422.21643`; the embedded build number is `2056`.
- Release tags like `v26.422.21643` trigger `.github/workflows/linux-release.yml`.
